...
public class VerleihServiceImplTest
{
    ...
    @Test
    public void testVerleiheAnFuegtEin()
    {
        ...
        //assertEquals(_verleihService.getVerleihkarteFuer(_abbey).getEntleiher(),_brian);
        //assertTrue(_verleihService.getVerleihkarteFuer(_abbey).getEntleiher().equals(_brian));
        //assertTrue(_verleihService.getVerleihkarteFuer(_bad).getEntleiher().equals(_brian));
        //assertFalse(_verleihService.getVerleihkarteFuer(_shape).getEntleiher().equals(_brian));
    }
