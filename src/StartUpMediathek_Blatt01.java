 ...
 * Fachlich geht es um die Verwaltung von physischen Medien.
 * Technisch muss für eine JavaFX-Anwendung die Klasse Application beerbt werden.
 * 
...
public class StartUpMediathek_Blatt01 extends Application
{
    ...
    private static final File KUNDEN_DATEI = new File("./bestand/kundenstamm.txt");
    private static final File MEDIEN_DATEI = new File("./bestand/medienbestand.txt");
	...
	public void start(Stage primaryStage) throws Exception {
        ...
        final MediathekWerkzeug mediathekWerkzeug = new MediathekWerkzeug(primaryStage,
